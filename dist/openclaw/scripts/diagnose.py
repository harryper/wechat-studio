#!/usr/bin/env python3
"""
Diagnose which anti-AI measures are active in this WeChat Studio installation.
...
def format_text(checks, summary, recs):
    ...
    lines = ["WeChat Studio Anti-AI Diagnostic", "=" * 26, ""]
...
def main():
    parser = argparse.ArgumentParser(
        description="Diagnose which anti-AI measures are active in this WeChat Studio installation.",
    )
